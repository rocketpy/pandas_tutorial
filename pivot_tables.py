...
df.pivot_table(values='col_name', index='row', columns=['item', 'col_name_2'], fill_value=0, aggfunc='mean')
# or
df.groupby(['row', 'item', 'col'])['col_name'].mean().unstack(['item', 'col']).fillna(0).sort_index(1)
